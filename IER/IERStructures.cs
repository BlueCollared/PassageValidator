...
namespace IFS2.Equipment.HardwareInterface.IERPLCManager
{
    ...
    public class GetStatusStdAnswer
    {
        ...
        public bool Set(object obj, LogContext log)
        {
            try
            {
                ...
                Logging.Verbose(log,"IERStructures.Decode GetStatusStd " + ToXml());
                return true;
            }
            catch (Exception e)
            {
                Logging.Error(log, "IERStructures.Decode GetStatusStd " + e.Message);
                Logging.Error(log, "IERStructures.Decode GetStatusStd " + ToXml());
            }
            return false;
        }
    }
